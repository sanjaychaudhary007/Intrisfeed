...
public class FeedArticlesAdapter extends BaseAdapter {
    Context mContext;
    ...
    public FeedArticlesAdapter(Context mCtx, ArrayList<HashMap<String, String>> list, FragmentManager fm) {
        this.mContext = mCtx;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            // inflate the layout
            convertView = inflater.inflate(R.layout.adapter_feed_articles, parent, false);

            // well set up the ViewHolder
            viewHolder = new ViewHolderItem();
            viewHolder.tvCategoryName = (TextView) convertView.findViewById(R.id.tvArticlesCategory);
            viewHolder.tvFeedLink = (TextView) convertView.findViewById(R.id.tvArticleContent);
            viewHolder.ivSendMail = (ImageView) convertView.findViewById(R.id.ivSendMail_ArticlesAdapter);
